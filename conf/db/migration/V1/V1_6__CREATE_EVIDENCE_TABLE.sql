CREATE TABLE evidences (
   ...
   size BIGINT,
   duplicate_hash CHAR(64) --can have lenght of 64, so we will check the first 16 for duplicate
);
...
CREATE INDEX idx_evidence_duplicate_hash ON evidences(duplicate_hash);
